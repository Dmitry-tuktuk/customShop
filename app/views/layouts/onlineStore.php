...
<head>
    ...
    <link rel="stylesheet" href="public/assets/css/plugins/venobox.css" />
                ...
                <div class="col align-self-center d-none d-lg-block">
                    <div class="main-menu">
                        <ul>
                            ...
                            <li class="title"><a href="blog-grid-left-sidebar.html">Blog</a></li>
    ...
    <div class="inner">
        ...
        <div class="foot">
            <div class="buttons mt-30px">
                ...
                <a type="button" class="btn btn-dark btn-outline-dark current-btn" onclick="clearCart">Clear Cart</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="inner customScroll">
        ...
        <div class="offcanvas-menu mb-4">
            <ul>
                ...
                <li><a href="blog-grid-left-sidebar.html">Blog</a></li>
                <li><a href="about.html">About Us</a></li>
                <li><a href="contact.html">Contact Us</a></li>
            </ul>
        </div>
                    ...
                    <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                        <div class="single-wedge">
                            <div class="footer-logo">
                                <a href="index.html"><img src="public/assets/images/logo/logo-white.png" alt=""></a>
                            </div>
                    ...
                    <div class="col-md-4 col-lg-3 col-sm-6">
                        <div class="single-wedge">
                            ...
                            <div class="footer-links">
                                ...
                                <img src="public/assets/images/icons/payment.png" alt="" class="payment-img img-fulid">
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="public/assets/images/product-image/zoom-image/1.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="public/assets/images/product-image/zoom-image/2.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="public/assets/images/product-image/zoom-image/3.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="public/assets/images/product-image/zoom-image/4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-container zoom-thumbs mt-3 mb-3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="public/assets/images/product-image/small-image/1.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="public/assets/images/product-image/small-image/2.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="public/assets/images/product-image/small-image/3.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="public/assets/images/product-image/small-image/4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
