        ...
        <div class="container position-relative">
            <div class="row">
                ...
                <div class="col align-self-center d-none d-lg-block">
                    <div class="main-menu">
                        <ul>
                            <li class="dropdown"><a href="<?=PATH;?>"">Home <i class="pe-7s-angle-down"></i></a>
                                <ul class="sub-menu">
                                    <li><a href="<?=PATH;?>"">Home 1</a></li>
                                        ...
                                        <ul class="menu-banner w-100">
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img
                                                            ...
                                                            src="public//images/banner/7.jpg" alt=""></a>
                                            </li>
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
        ...
        <div class="offcanvas-menu mb-4">
            <ul>
                <li><a href="#"><span class="menu-text">Home</span></a>
                    <ul class="sub-menu">
                        <li><a href="<?=PATH;?>""><span class="menu-text">Home 1</span></a></li>
                    ...
                    <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                        <div class="single-wedge">
                            <div class="footer-logo">
                                <a href="<?=PATH;?>""><img src="public/assets/images/logo/logo-white.png" alt=""></a>
                            </div>
                    ...
                    <div class="col-md-3 col-lg-2 col-sm-6 mb-lm-30px pl-lg-50px">
                        <div class="single-wedge">
                            ...
                            <div class="footer-links">
                                <div class="footer-row">
                                    <ul class="align-items-center">
                                        <li class="li"><a class="single-link" href="<?=PATH;?>"">Jesco</a>
                                        </li>
